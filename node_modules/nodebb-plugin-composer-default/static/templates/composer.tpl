<div component="composer" class="composer {{{ if resizable }}} resizable{{{ end }}}{{{ if !isTopicOrMain }}} reply{{{ end }}}">
	<div class="composer-container d-flex flex-column gap-1 h-100">
		...
		<div class="p-2 d-flex flex-column gap-1 h-100">
			...
			<!-- Suggested Responses -->
			<div class="composer-suggested-responses">
			<span class="suggested-response" data-response="Thanks!">Thanks!</span>
			<span class="suggested-response" data-response="Makes sense.">Makes sense.</span>
			<span class="suggested-response" data-response="Sounds good!">Sounds good!</span>
			<span class="suggested-response" data-response="Could you explain further?">Could you explain further?</span>
			</div>

			<style>
			.composer-suggested-responses {
				margin-top: 10px;
			}
			...
			.suggested-response:hover {
				background-color: #c5cae9; /* Slightly darker blue on hover */
			}
			</style>
