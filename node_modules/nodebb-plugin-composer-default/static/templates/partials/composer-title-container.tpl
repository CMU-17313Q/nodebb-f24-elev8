<div class="title-container align-items-center gap-2 d-flex">
	...
	<div data-component="composer/anonymous" class="d-flex align-items-center ms-2">
		<div class="form-check mb-0">
			<input
				class="form-check-input"
				type="checkbox"
				id="anonymous-checkbox"
				data-action="toggle-anonymous"
			/>
			<label
				class="form-check-label ms-1"
				for="anonymous-checkbox"
				style="font-size: 0.875em; color: #000000;"
			>
				<i class="fa fa-user-secret" style="font-size: 0.9em; color: #000000;"></i> Anonymous
			</label>
		</div>
	</div>
