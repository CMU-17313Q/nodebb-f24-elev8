		...
		<ul component="topic" class="posts timeline" data-tid="{tid}" data-cid="{cid}">
			...
			<div class="emoji-reactions" data-pid="{posts.pid}">
				<button class="reaction" data-reaction="👍">
        			<i class="fa fa-thumbs-up"></i> (<span id="count-👍-{posts.pid}">0</span>)
    			</button>
    			<button class="reaction" data-reaction="❤️">
        			<i class="fa fa-heart"></i> (<span id="count-❤️-{posts.pid}">0</span>)
    			</button>
    			<button class="reaction" data-reaction="😂">
        			<i class="fa fa-laugh"></i> (<span id="count-😂-{posts.pid}">0</span>)
    			</button>
			</div>
				</li>
